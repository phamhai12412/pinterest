let seach = JSON.parse(localStorage.getItem("seach"));
...
///==========mở chức năng load dữ liệu từ data với từ khóa tìm kiếm trên data
...
imagenes.onclick = function (event) {
  ...
  ////============== kết thúc chức năng view nhớ từ khóa viewid để gọi lại vị trí đã đánh dấu từ data
  /**
   */
  //============== mở chức năng lưu
